              ...
              <tr><td align="center" style="padding:32px 16px;">
                <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="width:600px; max-width:600px; background:#FFFFFF; border-radius:16px; overflow:hidden; border:1px solid #E4DFD3;">
                  ...
                  <tr><td style="padding:38px 44px 8px;">
                    <h1 style="margin:0 0 16px; font-family:'Sora','Inter',Arial,sans-serif; font-size:27px; line-height:1.25; font-weight:700; color:#363636; letter-spacing:-0.02em;">Verify your student status</h1>
                    <p style="margin:0; font-family:'Inter',Arial,sans-serif; font-size:16px; line-height:1.6; color:#6B6482;">Enter this code in GoHustlr to confirm your school email:</p>
                  </td></tr>
                  <tr><td align="center" style="padding:18px 44px 8px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#F7F4EC; border:1px solid #E4DFD3; border-radius:14px;">
                      <tr><td align="center" style="padding:22px 16px; font-family:'Sora','Inter',Arial,sans-serif; font-size:40px; line-height:1.1; font-weight:700; letter-spacing:12px; text-indent:12px; color:#5038FF;">${code}</td></tr>
                    </table>
                  </td></tr>
                  <tr><td style="padding:18px 44px 6px;">
                    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background:#FDF0DA; border-radius:12px;">
                      <tr><td style="padding:14px 16px; font-family:'Inter',Arial,sans-serif; font-size:13px; line-height:1.6; color:#8A5A12;">This code expires in 15 minutes. GoHustlr will never ask you for it &mdash; don&rsquo;t share it with anyone. Didn&rsquo;t request it? You can safely ignore this email.</td></tr>
                    </table>
                  </td></tr>
                  <tr><td style="padding:26px 44px 34px; border-top:1px solid #E4DFD3;">
                    <p style="margin:0 0 8px; font-family:'Inter',Arial,sans-serif; font-size:13px; line-height:1.5;">
                      <a href="mailto:mainmail@gohustlr.com" style="color:#5038FF; text-decoration:none;">Help</a> &middot;
                      <a href="https://gohustlr.com/legal/privacy" style="color:#5038FF; text-decoration:none;">Privacy</a> &middot;
                      <a href="https://gohustlr.com/legal/terms" style="color:#5038FF; text-decoration:none;">Terms</a>
                    </p>
