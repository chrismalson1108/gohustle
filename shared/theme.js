...
export const gradients = {
  primary: ['#6D28D9', '#4338CA'],
  earn: ['#059669', '#0D9488'],
  gold: ['#F59E0B', '#DC2626'],
  profile: ['#4338CA', '#6D28D9'],
};
...
export const cssGradients = {
  ...
  earn: 'linear-gradient(135deg, #059669, #0D9488)',
  gold: 'linear-gradient(135deg, #F59E0B, #DC2626)',
  profile: 'linear-gradient(135deg, #4338CA, #6D28D9)',
};
