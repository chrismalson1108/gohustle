...
export default function WorkStatusBar() {
  ...
  return (
    <div className="rounded-2xl bg-white p-3 shadow-[var(--shadow-card)] ring-1 ring-line/70">
      <p className="mb-2 px-1 text-xs font-bold text-ink-soft">Your work status</p>
          ...
          return (
            <button
              ...
              className={classNames(
                ...
                active ? "bg-primary text-white" : "bg-canvas text-ink-soft hover:bg-primary-light/50",
              )}
            >
