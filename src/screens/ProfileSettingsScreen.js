...
export default function ProfileSettingsScreen({ navigation }) {
  ...
  const { showToast, setRole, refreshProfile, avatarUrl, avatarInitial } = useUser();
  ...
  // Profile photo. This lives here because the You tab's header avatar now OPENS the
  // public profile (Strava-style) instead of picking an image, so without this there
  // would be no way to change your photo at all.
    ...
    <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
      ...
      <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 60 }} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.form}>
          ...
          <TouchableOpacity style={styles.avatarRow} onPress={handlePickAvatar} activeOpacity={0.8}>
            <View>
              <Avatar url={avatarUrl} initial={avatarInitial} size={64} fontSize={26} />
            ...
            <View style={{ flex: 1, marginLeft: 14 }}>
              <Text style={styles.avatarTitle} numberOfLines={1}>Profile photo</Text>
              <Text style={styles.avatarSub} numberOfLines={2}>Tap to choose a new picture</Text>
            </View>
...
const styles = StyleSheet.create({
  ...
  avatarTitle: { fontSize: 15, fontWeight: '600', color: colors.textPrimary },
  avatarSub: { fontSize: 13, color: colors.textMuted, marginTop: 2 },
